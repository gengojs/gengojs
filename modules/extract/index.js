...
var Extract = Proto.extend({
    ...
    init: function(array) {
        ...
        //if they are exactly 1 argument
            ...
            value = array[0];
            //set arguments [...]
            args = _.isArray(value) ? value : _.isObject(value) ? [] : args.push(value);
            //set values {...}
 ...
 * @return {Extract}     The instance of Extract.
 */
module.exports = function extract(args) {
    return Extract.create(Array.prototype.slice.call(args, 1));
};